...
export const tourPackages: TourPackage[] = [
  ...
  {
    id: 'jim-corbett',
    name: 'Jim Corbett Safari Package',
    seoTitle: 'Jim Corbett Safari Package from Delhi | 1N 2D ₹7,199 | Shri Taxi',
    seoDesc: 'Book Jim Corbett Safari Package from Delhi or Dehradun starting ₹7,199 (1 night 2 days, Sedan). Dhikala Zone, Tiger Reserve, Kosi River. Cab only, all inclusive.',
    days: 2,
    nights: 1,
    tag: 'Wildlife',
    badgeColor: '#16a34a',
    href: '/packages/jim-corbett',
    highlights: ['Jim Corbett Jeep Safari', 'Dhikala Zone', 'Garjiya Devi Temple', 'Kosi River Evening', 'Tiger Reserve', 'Bird Watching'],
    itinerary: ['Day 1: Delhi/Dehradun → Ramnagar (Jim Corbett) · Resort check-in · Kosi riverside evening', 'Day 2: Early morning Jeep Safari → Return Delhi/Dehradun'],
    includes: ['Cab with experienced driver', 'Fuel charges', 'Toll & parking', 'All taxes'],
    excludes: ['Air fare / Train fare throughout the tour', 'Hotel / Accommodation charges', 'All meals (breakfast, lunch, dinner)', 'Personal expenses (laundry, telephone, tips, porterage)', 'Entrance fees & video camera permits', 'Jungle safari in Corbett National Park', 'Local guide / escort charges', 'Travel insurance', 'Any extra vehicle usage beyond itinerary', 'Peak season surcharge (if applicable)', 'Medical expenses', 'Any cost due to natural calamities, landslides, road blockage or political disturbances', 'Any increase in taxes or fuel prices prior to departure'],
    tiers: tiers(2),
  },
  {
    ...
    seoTitle: 'Jim Corbett Wildlife Safari Package from Delhi | 2N 3D ₹10,799 | Shri Taxi',
    seoDesc: 'Book Jim Corbett 2 night 3 day wildlife safari package from Delhi or Dehradun starting ₹10,799 (Sedan). Two jeep safaris, Bijrani & Dhikala zones. Cab only, all inclusive.',
    days: 3,
    nights: 2,
    tag: 'Wildlife',
    badgeColor: '#16a34a',
    href: '/packages/jim-corbett-3d',
    highlights: ['Two Jeep Safaris', 'Dhikala & Bijrani Zones', 'Garjiya Devi Temple', 'Tiger Reserve', 'Corbett Museum', 'Kosi River'],
    itinerary: ['Day 1: Delhi/Dehradun → Ramnagar · Resort check-in · Evening at Kosi riverside', 'Day 2: Morning Jeep Safari (Dhikala/Bijrani) · Corbett Museum · Garjiya Devi Temple', 'Day 3: Early morning second Jeep Safari → Return Delhi/Dehradun'],
    includes: ['Cab with experienced driver', 'Fuel charges', 'Toll & parking', 'All taxes'],
    excludes: ['Air fare / Train fare throughout the tour', 'Hotel / Accommodation charges', 'All meals (breakfast, lunch, dinner)', 'Personal expenses (laundry, telephone, tips, porterage)', 'Entrance fees & video camera permits', 'Jungle safari in Corbett National Park', 'Local guide / escort charges', 'Travel insurance', 'Any extra vehicle usage beyond itinerary', 'Peak season surcharge (if applicable)', 'Medical expenses', 'Any cost due to natural calamities, landslides, road blockage or political disturbances', 'Any increase in taxes or fuel prices prior to departure'],
    tiers: tiers(3),
  },
