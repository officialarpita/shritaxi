...
export const tourPackages: TourPackage[] = [
  ...
  {
    id: 'lansdowne',
    name: 'Lansdowne Day Trip',
    seoTitle: 'Lansdowne Day Trip from Dehradun | ₹3,599 | Hill Station & Army Town',
    seoDesc: 'Book Lansdowne day trip cab from Dehradun starting ₹3,599. Peaceful hill station, Bhulla Lake, War Memorial, dense oak forests. All inclusive.',
    days: 1,
    nights: 0,
    tag: 'Day Trip',
    badgeColor: '#16a34a',
    href: '/packages/lansdowne',
    highlights: ['Bhulla Lake', 'War Memorial', 'Tip-n-Top Viewpoint', 'St. Mary\'s Church'],
    itinerary: ['Morning: Depart Dehradun', 'Bhulla Lake & War Memorial', 'Tip-n-Top viewpoint', 'St. Mary\'s Church → Return'],
    includes: ['Cab with experienced driver', 'Fuel charges', 'Toll & parking', 'All taxes'],
    faqs: [
  ...
  {
    id: 'mukteshwar',
    name: 'Mukteshwar Day Trip',
    seoTitle: 'Mukteshwar Day Trip from Dehradun | ₹3,599 | Apple Orchards & Himalayan Views',
    seoDesc: 'Book Mukteshwar day trip cab from Dehradun starting ₹3,599. Stunning Himalayan views, apple orchards, Mukteshwar temple, Chauli Ki Jali. All inclusive.',
    days: 1,
    nights: 0,
    tag: 'Day Trip',
    badgeColor: '#f59e0b',
    href: '/packages/mukteshwar',
    highlights: ['Mukteshwar Temple', 'Chauli Ki Jali', 'Apple Orchards', 'Himalayan Views'],
    itinerary: ['Morning: Depart Dehradun', 'Mukteshwar Temple', 'Chauli Ki Jali rock face', 'Apple orchards → Return'],
    includes: ['Cab with experienced driver', 'Fuel charges', 'Toll & parking', 'All taxes'],
    faqs: [
