...
export const tourPackages: TourPackage[] = [
  ...
  {
    id: 'munsiyari',
    name: 'Munsiyari Tour Package',
    seoTitle: 'Munsiyari Tour Package with Cab from Dehradun | 3 Days ₹10,999',
    seoDesc: 'Book 3 day Munsiyari tour package with cab from Dehradun starting ₹10,999. Khaliya Top, Nanda Devi views, Pithoragarh. All inclusive.',
    days: 3,
    nights: 2,
    tag: 'Adventure',
    badgeColor: '#3b82f6',
    href: '/packages#munsiyari',
    highlights: ['Munsiyari Hill Station', 'Khaliya Top Trek', 'Nanda Devi Views', 'Pithoragarh Fort'],
...
export const vehicleRates = {
  ...
  innova:     { id: 'innova',    name: 'Toyota Innova Crysta', seats: 6, perDay: 6300, mrpPerDay: 6300  },
  traveller:  { id: 'traveller', name: 'Tempo Traveller',      seats: 12, perDay: 8999, mrpPerDay: 8999 },
  // Traveller MRP = ₹8,999/day so after 10% = ~₹8,099 ≈ ₹8,000 target
};
...
function tiers(days: number, sedanOverride?: number): PricingTier[] {
  ...
  return vehicles.map((v, i) => {
    ...
    // Strategic price rounding for better UX
    if (i === 0 && sedanOverride) {
      discounted = sedanOverride;
    } else if (discounted > 50000) {
      discounted = Math.round(discounted / 1000) * 1000 - 1;
...
export const tourPackages: TourPackage[] = [
  {
    id: 'surkanda-devi',
    name: 'Surkanda Devi Mandir Day Trip',
    seoTitle: 'Surkanda Devi Mandir Taxi from Dehradun | 1 Day Trip',
    seoDesc: 'Book cab for Surkanda Devi Mandir from Dehradun. 1 day trip starting ₹3,599. All inclusive — toll, parking, driver included.',
    days: 1,
    nights: 0,
    tag: 'Day Trip',
    badgeColor: '#0d9488',
    href: '/packages#surkanda-devi',
    highlights: ['Surkanda Devi Temple', 'Dhanaulti Eco Park', 'Chamba Town', 'Scenic Himalayan Views'],
    itinerary: ['Morning: Depart Dehradun', 'Reach Surkanda Devi Temple', 'Dhanaulti sightseeing', 'Evening: Return Dehradun'],
    includes: ['Cab with experienced driver', 'Fuel charges', 'Toll & parking', 'All taxes'],
    tiers: tiers(1),
  },
  {
